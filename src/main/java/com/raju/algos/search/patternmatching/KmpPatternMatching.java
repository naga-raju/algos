package com.raju.algos.search.patternmatching;
...
public class KmpPatternMatching {
	...
	public static void main(String[] args) {
		KmpPatternMatching stm = new KmpPatternMatching();
		// pattern
		char[] ptrn = "aaaaaaaaaab".toCharArray(); //"abcabdabc".toCharArray();

		char[] text = "aaaaaaaaaaab".toCharArray();//"abcabdabcabeabcabdabcabd".toCharArray();
		System.out.print(" ");
		for (char c : text) {
			System.out.print(c + "   ");
		}
